...
final class TermuxPreferences {
    ...
    void reloadFromProperties(Context context) {
        ...
        String defaultExtraKeys = "[[{key: '~',popup: '*'}, {key: '\\/', popup: '?'}, {key: ':', popup: ';'}, {key: '!', popup: {macro: 'ESC F5 ENTER', display: 'RUN'}}, {key: '-', popup: '_'}, {key: '=', popup: '+'}, {key: 'UP', popup: 'PGUP'}, {key: 'KEYBOARD', popup: {macro: 'ESC F5 ENTER', display: 'RUN'}}],[{key: 'ESC', popup: {macro: 'ESC :conf SPACE qa ENTER', display: 'exit?'}}, {key: 'TAB', popup: {macro: 'ESC :w ENTER', display: 'save'}}, {key: 'CTRL', popup: {macro: 'ESC :q ENTER', display: 'quit'}}, {key: 'ALT', popup: {macro: 'ESC :sh ENTER', display: 'shell'}}, {key: 'BACKSLASH', popup: '|'}, {key: 'LEFT', popup: 'HOME'}, {key: 'DOWN', popup: 'PGDN'}, {key: 'RIGHT', popup: 'END'}]]";
